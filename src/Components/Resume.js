    ...
    return (
            ...
            <div className="row item">
               <div className="twelve columns">
                    <div>
                        ...
                        <p className="info">{"Bachelor of Science in Computer Science"} <span>&bull;</span><em className="date">{"Class of 2020"}</em></p>
                    </div>
                    <div>
                        <h3>{"Make School Summer Academy"}</h3>
                        <p className="info">{"VR Development Track"} <span>&bull;</span><em className="date">{"June 2017-Aug 2017"}</em></p>
                    </div>
               </div>
            </div>
         </div>
      ...
      <div className="row work">
         ...
         <div className="nine columns main-col">
            ...
            <div><h3>{"Mobile AR Developer"}</h3>
                <p className="info">{"Michigan State University IT"}<span>&bull;</span> <em className="date">{"May 2018 - Aug 2018"}</em></p>
                <ul>
                    <li>- Developed spARtan, a location-based augmented reality iOS application that takes the current position and identifies nearby points of interests in an AR space</li>
                    <li>- Assisted with design and features for the official MSU mobile application</li>
