    ...
    return (
      ...
      <div className="row banner">
         <div className="banner-text">
            <img className="profile-pic"  src="images/don.png" alt="Don Nakashima Profile Pic" />
            <h1 className="responsive-headline">Don Nakashima</h1>
            <h3>
                Michigan State Alumnus. Software Engineer. <br />
                Currently situated at Atomic Object as a Software Developer & Consultant. <br />
                Member of Cell Gamma - Atomic's <a href="https://atomicobject.com/careers/accelerator">Accelerator</a> Program. <br />
            </h3>
            <hr />
